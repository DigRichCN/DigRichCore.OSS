...
namespace DigRichCore.OSS {
    public interface IOSSProvider {
        ...
        /// <param name="includeFile">递归文件</param>
        /// <returns></returns>
        bool CopyFolder(string fromDirName, string toDirName, bool includeFile);
        /// <summary>
        /// 创建普通文件（该文件不可追加内容）
        /// </summary>
        /// <param name="ordinalUrl">文件网络地址</param>
        /// <param name="fileName">文件名</param>
        /// <returns>文件地址</returns>
        string CreateFileByUrl(string ordinalUrl, string fileName);
